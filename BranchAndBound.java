...
public class BranchAndBound {
	...
	void outputSolution (Node node) {
		...
		// Output the solution
		System.out.println("Assigned machine " + Integer.toString(node.getMachine()) + " to the task " + node.getTask() + ".");
	...
	public static void main (String args[]) {
		...
		Pair<Integer, String> t1 = new Pair(1, "A");
		hc1.add(t1);
	    ...
	    Pair<String, String> t2 = new Pair("E", "F");
	    hc3.add(t2);
	    ...
	    Pair<Pair<String, String>, Integer> t3 = new Pair(new Pair("A", "B"), 100);
	    sc2.add(t3);
